...
return array(
    ...
    "console.command.help.withdebug" => "Shows the Debug of the %software% system",
    ...
    "console.command.version.help" => "\tUsage: php console version\n\tShows the version of all %software% components and of all installed plugins",
);
